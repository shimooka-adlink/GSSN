...
//    List file    =  
//        C:\GNSS\Software\rJ105\source\GNSS_GW\board\S5U1C31W74T1\IAR\DebugFlashBside\List\ctrl_I2C1.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        EXTERN i2c1_end
        EXTERN i2c1_init
        EXTERN i2c1_re_start

        PUBLIC ctrl_I2C1_end
        PUBLIC ctrl_I2C1_init
        PUBLIC ctrl_I2C1_re_start
...
ctrl_I2C1_end:
        PUSH     {R7,LR}
          ...
          CFI CFA R13+8
//   76 	i2c1_Disable();
          CFI FunCall i2c1_Disable
        BL       i2c1_Disable
//   77 	i2c1_end();
          CFI FunCall i2c1_end
        BL       i2c1_end
//   78 }
        POP      {R0,PC}          ;; return
...
//   89 /********************************************************************/
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function ctrl_I2C1_re_start
        THUMB
