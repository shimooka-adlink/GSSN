...
uint8_t  data_send_ACK_rev;             /*!< Flag active while IN ACK recived */
...
static int32_t    USBD_CDC_ACM_EP_BULKIN_HandleData    (void);
...
//+++---------------------------------------------------------------------
    ...
    return USBD_CDC_ACM_EP_BULKIN_HandleData();
}
