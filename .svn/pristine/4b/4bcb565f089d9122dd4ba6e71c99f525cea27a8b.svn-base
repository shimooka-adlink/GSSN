...
/** @defgroup USBD_Exported_Constants
  * @{
*/
/**
...
/** @defgroup USBD_Public_Functions
  * @{
  */
...
typedef struct _ARM_DRIVER_USBD {
  ...
  int32_t               (*EndpointConfigure)         (uint8_t ep_addr, uint8_t ep_type,uint16_t ep_max_packet_size);                       ///< Pointer to \ref ARM_USBD_EndpointConfigure : Configure USB Endpoint.
