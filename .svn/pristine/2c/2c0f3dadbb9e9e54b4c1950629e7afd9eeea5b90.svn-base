...
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  C:\GNSS\Software\rJ105\source\GNSS_GW\apl\man_lte.c
//    Command line =  
//        C:\GNSS\Software\rJ105\source\GNSS_GW\apl\man_lte.c -D
...
//    List file    =  
//        C:\GNSS\Software\rJ105\source\GNSS_GW\board\S5U1C31W74T1\IAR\DebugFlashBside\List\man_lte.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        EXTERN man_gpio_lte_power_get
        EXTERN man_gpio_lte_pwrkey
        EXTERN man_gpio_lte_reset
        EXTERN man_http_get_status
        EXTERN man_http_lte_close
        EXTERN man_http_lte_exec_reset
        EXTERN man_http_lte_get_cpsi
        EXTERN man_http_lte_init
        EXTERN man_http_lte_open
        EXTERN man_http_lte_ota_off
        EXTERN man_http_lte_ready
        EXTERN man_http_lte_state
        EXTERN man_http_lte_stby_in
        EXTERN man_http_lte_stby_out
        EXTERN man_http_set_rssi_ng
        EXTERN man_timer_cancel_wait
        EXTERN man_timer_start_wait
        EXTERN man_usb_data_send
        EXTERN mid_HTTP_req_LTE_PowerOFF
        EXTERN seSysSleepMS
        EXTERN sprintf
        EXTERN strlen
        EXTERN sysmgr_log
        ...
        PUBLIC man_let_get_data
        PUBLIC man_lte_1000ms_main
        PUBLIC man_lte_disp_info
        PUBLIC man_lte_init
        PUBLIC man_lte_main
        PUBLIC man_lte_noti_state
        PUBLIC man_lte_req_init
        PUBLIC man_lte_req_off
        PUBLIC man_lte_req_ready
        PUBLIC man_lte_req_reset
        PUBLIC man_lte_req_start
        PUBLIC man_lte_req_state
        PUBLIC man_lte_req_stby
        PUBLIC man_lte_req_stop
        PUBLIC man_lte_req_wakeup
        PUBLIC man_lte_work
...
// C:\GNSS\Software\rJ105\source\GNSS_GW\apl\man_lte.c
//    1 
//    2 /**
//    3   ******************************************************************************
//    4   * @file    man_lte.c
...
//  304 /********************************************************************/
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function man_lte_return_callback
        THUMB
//  305 static void man_lte_return_callback( int32_t status )
//  306 {
man_lte_return_callback:
        PUSH     {R7,LR}
          CFI R14 Frame(CFA, -4)
          CFI CFA R13+8
//  307 
...
??man_lte_return_callback_0:
        MOVS     R0,#+0
          CFI FunCall man_lte_set_sequense
        BL       man_lte_set_sequense
...
//  337 	man_http_lte_state(MAN_LTE_NOTI_STATE, man_lte_req_callback);
        ...
        MOVS     R0,#+250
        LSLS     R0,R0,#+2        ;; #+1000
          CFI FunCall man_http_lte_state
        BL       man_http_lte_state
//  338 }
        POP      {R4,PC}          ;; return
...
??DataTable3:
        ...
        DATA
??DataTable3_1:
        DC32     man_lte_work+0xA4

        SECTION `.text`:CODE:NOROOT(2)
        SECTION_TYPE SHT_PROGBITS, 0
        DATA
??DataTable3_2:
        DC32     man_lte_req_callback
//  339 
//  340 
//  341 /********************************************************************/
//  342 /*!
...
??man_lte_main_4:
          CFI FunCall man_http_set_rssi_ng
        BL       man_http_set_rssi_ng
//  379 
...
//  391 					man_timer_cancel_wait(TIMER_MAN_ID_APL_LTE + MAN_LTE_SEQ_LTE_STBY_OUT_OK_WAIT, MAN_LTE_STBY_OUT_NG_WAIT_TIME);
        LDR      R1,??man_lte_main_0+0x4  ;; 0x1388
        LDR      R0,??man_lte_main_0+0x8  ;; 0x40400032
...
//  395 					man_lte_return_callback(MAN_LTE_STATUS_OK);
        MOVS     R0,#+0
          CFI FunCall man_lte_return_callback
        BL       man_lte_return_callback
        B        ??man_lte_main_11
//  396 				}
//  397 
...
//  400 					man_timer_cancel_wait(TIMER_MAN_ID_APL_LTE + MAN_LTE_SEQ_LTE_STBY_OUT_NG_WAIT, MAN_LTE_STBY_OUT_NG_WAIT_TIME);
        LDR      R1,??man_lte_main_0+0x4  ;; 0x1388
        LDR      R0,??man_lte_main_0+0xC  ;; 0x40400036
          CFI FunCall man_timer_cancel_wait
        BL       man_timer_cancel_wait
//  401 					// LTE スタンバイ解除済み
...
//  409 					man_timer_cancel_wait(TIMER_MAN_ID_APL_LTE + MAN_LTE_SEQ_LTE_ATRESET_WAIT, MAN_LTE_RESET_WAIT_TIME);
        LDR      R1,??man_lte_main_0+0x10  ;; 0xea60
        LDR      R0,??man_lte_main_0+0x14  ;; 0x40400047
          CFI FunCall man_timer_cancel_wait
        BL       man_timer_cancel_wait
//  410 					// LTEが起床済み
...
//  433 					man_timer_cancel_wait(TIMER_MAN_ID_APL_LTE + MAN_LTE_SEQ_LTE_STOP_NG_WAIT, MAN_LTE_CLOSE_WAIT_TIME);
        LDR      R1,??man_lte_main_18  ;; 0x7530
        LDR      R0,??man_lte_main_18+0x4  ;; 0x40400026
          CFI FunCall man_timer_cancel_wait
        BL       man_timer_cancel_wait
...
??man_lte_main_9:
        MOVS     R0,#+14
        LDR      R1,??man_lte_main_18+0x8
        STR      R0,[R1, #+56]
//  476 				if (man_lte_work.noti_state.callback_state != NULL) {
        LDR      R0,??man_lte_main_18+0x8
        LDR      R0,[R0, #+52]
        CMP      R0,#+0
        BEQ      ??man_lte_main_25
...
??man_lte_main_75:
        LDR      R3,??man_lte_main_51+0x4  ;; 0x281
        LDR      R0,??man_lte_main_51+0x8
        LDR      R2,[R0, #+24]
        LDR      R0,??man_lte_main_51+0x8
        LDR      R1,[R0, #+20]
        MOVS     R0,#+24
...
??man_lte_main_52:
        LDR      R3,??man_lte_main_51+0xC  ;; 0x286
        LDR      R0,??man_lte_main_51+0x8
        LDR      R2,[R0, #+20]
        LDR      R0,??man_lte_main_51+0x8
        LDRB     R1,[R0, #+1]
...
//  809 		man_gpio_lte_pwrkey(MAN_GPIO_CTRL_OFF);		// PWRKEY OFF
        MOVS     R0,#+0
          CFI FunCall man_gpio_lte_pwrkey
        BL       man_gpio_lte_pwrkey
//  810 		seSysSleepMS(5);
        MOVS     R0,#+5
          CFI FunCall seSysSleepMS
        BL       seSysSleepMS
...
//  817 		ret = man_timer_start_wait(TIMER_MAN_ID_APL_LTE + MAN_LTE_SEQ_PWRKEY_ON_WAIT, MAN_LTE_PWRKEY_ON_WAIT_TIME, man_lte_req_callback);
        LDR      R2,??man_lte_main_177
        MOVS     R1,#+250
        LSLS     R1,R1,#+1        ;; #+500
        LDR      R0,??man_lte_main_177+0x4  ;; 0x40400002
          CFI FunCall man_timer_start_wait
        BL       man_timer_start_wait
//  818 		if (ret < 0) {
        CMP      R0,#+0
        BPL      ??man_lte_main_178
...
//  834 		ret = man_timer_start_wait(TIMER_MAN_ID_APL_LTE + MAN_LTE_SEQ_PWRKEY_OFF_WAIT, MAN_LTE_PWRKEY_OFF_WAIT_TIME, man_lte_req_callback);
        LDR      R2,??man_lte_main_177
        LDR      R1,??man_lte_main_179  ;; 0x59d8
        LDR      R0,??man_lte_main_179+0x4  ;; 0x40400005
          CFI FunCall man_timer_start_wait
        BL       man_timer_start_wait
//  835 		if (ret < 0) {
        CMP      R0,#+0
        BPL      ??man_lte_main_180
...
//  837 			man_error_setting(MAN_ERROR_MAN_LTE, 0, 0);
        LDR      R3,??man_lte_main_179+0x8  ;; 0x345
        MOVS     R2,#+0
        MOVS     R1,#+0
        MOVS     R0,#+24
          CFI FunCall man_error_set
...
??man_lte_main_106:
        LDR      R3,??man_lte_main_179+0xC  ;; 0x349
        MOVS     R2,#+0
        LDR      R0,??man_lte_main_102+0x4
        LDRB     R1,[R0, #+1]
        MOVS     R0,#+24
...
??man_lte_main_108:
          CFI FunCall man_gpio_lte_power_get
        BL       man_gpio_lte_power_get
        CMP      R0,#+1
        BNE      ??man_lte_main_181
//  853 			// POWER ON実施
...
//  885 			ret = man_http_lte_ota_off(MAN_LTE_SEQ_LTE_OTA_OFF, man_lte_req_callback);
        LDR      R1,??man_lte_main_177
        MOVS     R0,#+10
          CFI FunCall man_http_lte_ota_off
        BL       man_http_lte_ota_off
//  886 			if (ret < 0) {
        CMP      R0,#+0
        BPL      ??man_lte_main_184
//  887 				man_error_setting(MAN_ERROR_MAN_LTE, man_lte_work.sequense, 0);
        LDR      R3,??man_lte_main_183+0x4  ;; 0x377
        MOVS     R2,#+0
        LDR      R0,??man_lte_main_183+0x8
        LDRB     R1,[R0, #+1]
        MOVS     R0,#+24
          CFI FunCall man_error_set
        BL       man_error_set
...
//  918 		ret = man_timer_start_wait(TIMER_MAN_ID_APL_LTE + MAN_LTE_SEQ_LTE_OTA_OFF_NG_WAIT, MAN_LTE_OTA_OFF_WAIT_TIME, man_lte_req_callback);
        LDR      R2,??man_lte_main_177
        LDR      R1,??man_lte_main_186  ;; 0xbb8
        LDR      R0,??man_lte_main_186+0x4  ;; 0x4040000d
          CFI FunCall man_timer_start_wait
        BL       man_timer_start_wait
//  919 		if (ret < 0) {
        CMP      R0,#+0
        BPL      ??man_lte_main_187
...
//  921 			man_error_setting(MAN_ERROR_MAN_LTE, 0, 0);
        LDR      R3,??man_lte_main_186+0x8  ;; 0x399
        MOVS     R2,#+0
        MOVS     R1,#+0
        MOVS     R0,#+24
          CFI FunCall man_error_set
...
??man_lte_main_189:
        LDR      R3,??man_lte_main_186+0xC  ;; 0x3ae
        MOVS     R2,#+0
        MOVS     R1,#+0
        MOVS     R0,#+24
          CFI FunCall man_error_set
...
//  963 			ret = man_http_lte_init(MAN_LTE_SEQ_LTE_INIT, man_lte_req_callback);
        LDR      R1,??man_lte_main_177
        MOVS     R0,#+17
          CFI FunCall man_http_lte_init
        BL       man_http_lte_init
//  964 			if (ret < 0) {
        CMP      R0,#+0
        BPL      ??man_lte_main_191
//  965 				man_error_setting(MAN_ERROR_MAN_LTE, man_lte_work.sequense, 0);
        LDR      R3,??man_lte_main_186+0x10  ;; 0x3c5
        MOVS     R2,#+0
        LDR      R0,??man_lte_main_183+0x8
        LDRB     R1,[R0, #+1]
        MOVS     R0,#+24
...
??man_lte_main_122:
        LDR      R3,??man_lte_main_186+0x14  ;; 0x3d2
        MOVS     R2,#+0
        LDR      R0,??man_lte_main_183+0x8
        LDRB     R1,[R0, #+1]
        MOVS     R0,#+24
...
//  992 			ret = man_http_lte_ready(MAN_LTE_SEQ_LTE_READY, man_lte_req_callback);
        LDR      R1,??man_lte_main_177
        MOVS     R0,#+21
          CFI FunCall man_http_lte_ready
        BL       man_http_lte_ready
//  993 			if (ret < 0) {
        CMP      R0,#+0
        BPL      ??man_lte_main_192
//  994 				man_error_setting(MAN_ERROR_MAN_LTE, man_lte_work.sequense, 0);
        LDR      R3,??man_lte_main_193  ;; 0x3e2
        MOVS     R2,#+0
        LDR      R0,??man_lte_main_183+0x8
        LDRB     R1,[R0, #+1]
        MOVS     R0,#+24
...
??man_lte_main_126:
        LDR      R3,??man_lte_main_193+0x4  ;; 0x3ef
        MOVS     R2,#+0
        LDR      R0,??man_lte_main_183+0x8
        LDRB     R1,[R0, #+1]
        MOVS     R0,#+24
...
// 1022 			ret = man_http_lte_open(MAN_LTE_SEQ_LTE_START, man_lte_req_callback);
        LDR      R1,??man_lte_main_177
        MOVS     R0,#+25
          CFI FunCall man_http_lte_open
        BL       man_http_lte_open
// 1023 			if (ret < 0) {
        CMP      R0,#+0
        BPL      ??man_lte_main_194
...
// 1046 				ret = man_http_lte_close(MAN_LTE_SEQ_LTE_OPEN_STOP, man_lte_req_callback);
        LDR      R1,??man_lte_main_177
        MOVS     R0,#+28
          CFI FunCall man_http_lte_close
        BL       man_http_lte_close
// 1047 				if (ret < 0) {
        CMP      R0,#+0
        BPL      ??man_lte_main_195
...
// 1054 				man_error_setting(MAN_ERROR_MAN_LTE, 0, 0);
        LDR      R3,??man_lte_main_197+0x4  ;; 0x41e
        MOVS     R2,#+0
        MOVS     R1,#+0
        MOVS     R0,#+24
          CFI FunCall man_error_set
...
// 1067 		ret = man_timer_start_wait(TIMER_MAN_ID_APL_LTE + MAN_LTE_SEQ_LTE_OPEN_WAIT, MAN_LTE_OPEN_WAIT_TIME, man_lte_req_callback);
        LDR      R2,??man_lte_main_197+0x8
        LDR      R1,??man_lte_main_186  ;; 0xbb8
        LDR      R0,??man_lte_main_197+0xC  ;; 0x4040001f
          CFI FunCall man_timer_start_wait
        BL       man_timer_start_wait
// 1068 		if (ret < 0) {
        CMP      R0,#+0
        BPL      ??man_lte_main_198
...
// 1070 			man_error_setting(MAN_ERROR_MAN_LTE, 0, 0);
        LDR      R3,??man_lte_main_197+0x10  ;; 0x42e
        MOVS     R2,#+0
        MOVS     R1,#+0
        MOVS     R0,#+24
          CFI FunCall man_error_set
...
// 1089 			ret = man_http_lte_open(MAN_LTE_SEQ_LTE_START, man_lte_req_callback);
        LDR      R1,??man_lte_main_197+0x8
        MOVS     R0,#+25
          CFI FunCall man_http_lte_open
        BL       man_http_lte_open
// 1090 			if (ret < 0) {
        CMP      R0,#+0
        BPL      ??man_lte_main_201
...
// 1092 				man_error_setting(MAN_ERROR_MAN_LTE, 0, 0);
        LDR      R3,??man_lte_main_200+0x4  ;; 0x444
        MOVS     R2,#+0
        MOVS     R1,#+0
        MOVS     R0,#+24
          CFI FunCall man_error_set
...
// 1098 		man_error_setting(MAN_ERROR_MAN_LTE, 0, 0);
        LDR      R3,??man_lte_main_200+0x8  ;; 0x44a
        MOVS     R2,#+0
        MOVS     R1,#+0
        MOVS     R0,#+24
          CFI FunCall man_error_set
...
// 1112 			if (ret < 0) {
        CMP      R0,#+0
        BPL      ??man_lte_main_202
// 1113 				man_error_setting(MAN_ERROR_MAN_LTE, man_lte_work.sequense, 0);
        LDR      R3,??man_lte_main_203  ;; 0x459
        MOVS     R2,#+0
        LDR      R0,??man_lte_main_203+0x4
        LDRB     R1,[R0, #+1]
        MOVS     R0,#+24
          CFI FunCall man_error_set
        BL       man_error_set
...
// 1130 		ret = man_timer_start_wait(TIMER_MAN_ID_APL_LTE + MAN_LTE_SEQ_LTE_STOP_NG_WAIT, MAN_LTE_CLOSE_WAIT_TIME, man_lte_req_callback);
        LDR      R2,??man_lte_main_197+0x8
        LDR      R1,??man_lte_main_204  ;; 0x7530
        LDR      R0,??man_lte_main_204+0x4  ;; 0x40400026
          CFI FunCall man_timer_start_wait
        BL       man_timer_start_wait
// 1131 		if (ret < 0) {
        CMP      R0,#+0
        BPL      ??man_lte_main_205
...
// 1133 			man_error_setting(MAN_ERROR_MAN_LTE, 0, 0);
        LDR      R3,??man_lte_main_204+0x8  ;; 0x46d
        MOVS     R2,#+0
        MOVS     R1,#+0
        MOVS     R0,#+24
          CFI FunCall man_error_set
...
// 1163 			ret = man_http_lte_stby_in(MAN_LTE_SEQ_LTE_STBY_IN, man_lte_req_callback);
        LDR      R1,??man_lte_main_197+0x8
        MOVS     R0,#+44
          CFI FunCall man_http_lte_stby_in
        BL       man_http_lte_stby_in
// 1164 			if (ret < 0) {
        CMP      R0,#+0
        BPL      ??man_lte_main_207
// 1165 				man_error_setting(MAN_ERROR_MAN_LTE, man_lte_work.sequense, 0);
        LDR      R3,??man_lte_main_206+0x4  ;; 0x48d
        MOVS     R2,#+0
        LDR      R0,??man_lte_main_203+0x4
        LDRB     R1,[R0, #+1]
        MOVS     R0,#+24
...
// 1193 			ret = man_http_lte_stby_out(MAN_LTE_SEQ_LTE_STBY_OUT, man_lte_req_callback);
        LDR      R1,??man_lte_main_197+0x8
        MOVS     R0,#+48
          CFI FunCall man_http_lte_stby_out
        BL       man_http_lte_stby_out
// 1194 			if (ret < 0) {
        CMP      R0,#+0
        BPL      ??man_lte_main_208
// 1195 				man_error_setting(MAN_ERROR_MAN_LTE, man_lte_work.sequense, 0);
        LDR      R3,??man_lte_main_206+0x8  ;; 0x4ab
        MOVS     R2,#+0
        LDR      R0,??man_lte_main_203+0x4
        LDRB     R1,[R0, #+1]
        MOVS     R0,#+24
...
// 1205 		ret = man_timer_start_wait(TIMER_MAN_ID_APL_LTE + MAN_LTE_SEQ_LTE_STBY_OUT_OK_WAIT, MAN_LTE_STBY_OUT_NG_WAIT_TIME, man_lte_req_callback);
        LDR      R2,??man_lte_main_197+0x8
        LDR      R1,??man_lte_main_209  ;; 0x1388
        LDR      R0,??man_lte_main_209+0x4  ;; 0x40400032
          CFI FunCall man_timer_start_wait
        BL       man_timer_start_wait
// 1206 		if (ret < 0) {
        CMP      R0,#+0
        BPL      ??man_lte_main_210
...
// 1225 		ret = man_timer_start_wait(TIMER_MAN_ID_APL_LTE + MAN_LTE_SEQ_LTE_STBY_OUT_NG_WAIT, MAN_LTE_STBY_OUT_NG_WAIT_TIME, man_lte_req_callback);
        LDR      R2,??man_lte_main_197+0x8
        LDR      R1,??man_lte_main_209  ;; 0x1388
        LDR      R0,??man_lte_main_209+0x8  ;; 0x40400036
          CFI FunCall man_timer_start_wait
        BL       man_timer_start_wait
// 1226 		if (ret < 0) {
        CMP      R0,#+0
        BPL      ??man_lte_main_211
...
??man_lte_main_158:
        MOVS     R0,#+1
          CFI FunCall man_gpio_lte_reset
        BL       man_gpio_lte_reset
// 1259 		// 電波状況を圏外にする
...
// 1263 		ret = man_timer_start_wait(TIMER_MAN_ID_APL_LTE + MAN_LTE_SEQ_LTE_RESET_ON_WAIT, MAN_LTE_RESET_ON_WAIT_TIME, man_lte_req_callback);
        ...
        MOVS     R1,#+250
        LSLS     R1,R1,#+2        ;; #+1000
        LDR      R0,??man_lte_main_213  ;; 0x4040003d
          CFI FunCall man_timer_start_wait
        BL       man_timer_start_wait
// 1264 		if (ret < 0) {
        CMP      R0,#+0
        BPL      ??man_lte_main_214
...
// 1283 		ret = man_timer_start_wait(TIMER_MAN_ID_APL_LTE + MAN_LTE_SEQ_LTE_RESET_OFF_WAIT, MAN_LTE_PWRKEY_OFF_WAIT_TIME, man_lte_req_callback);
        LDR      R2,??man_lte_main_197+0x8
        LDR      R1,??man_lte_main_215+0x4  ;; 0x59d8
        LDR      R0,??man_lte_main_215+0x8  ;; 0x40400040
          CFI FunCall man_timer_start_wait
        BL       man_timer_start_wait
// 1284 		if (ret < 0) {
        CMP      R0,#+0
        BPL      ??man_lte_main_216
...
// 1286 			man_error_setting(MAN_ERROR_MAN_LTE, 0, 0);
        LDR      R3,??man_lte_main_215+0xC  ;; 0x506
        MOVS     R2,#+0
        MOVS     R1,#+0
        MOVS     R0,#+24
          CFI FunCall man_error_set
...
// 1307 			ret = man_http_lte_exec_reset(MAN_LTE_SEQ_LTE_ATRESET, man_lte_req_callback);
        LDR      R1,??man_lte_main_215+0x10
        MOVS     R0,#+68
          CFI FunCall man_http_lte_exec_reset
        BL       man_http_lte_exec_reset
// 1308 			if (ret < 0) {
        CMP      R0,#+0
        BPL      ??man_lte_main_217
// 1309 				man_error_setting(MAN_ERROR_MAN_LTE, man_lte_work.sequense, 0);
        LDR      R3,??man_lte_main_218  ;; 0x51d
        MOVS     R2,#+0
        LDR      R0,??man_lte_main_203+0x4
        LDRB     R1,[R0, #+1]
        MOVS     R0,#+24
...
// 1320 		ret = man_timer_start_wait(TIMER_MAN_ID_APL_LTE + MAN_LTE_SEQ_LTE_ATRESET_WAIT, MAN_LTE_RESET_WAIT_TIME, man_lte_req_callback);
        LDR      R2,??man_lte_main_215+0x10
        LDR      R1,??DataTable4  ;; 0xea60
        LDR      R0,??DataTable4_1  ;; 0x40400047
          CFI FunCall man_timer_start_wait
        BL       man_timer_start_wait
// 1321 		if (ret < 0) {
        CMP      R0,#+0
        BPL      ??man_lte_main_219
...
// 1356                 mid_HTTP_req_LTE_PowerOFF();
          CFI FunCall mid_HTTP_req_LTE_PowerOFF
        BL       mid_HTTP_req_LTE_PowerOFF
// 1357 		// 3秒タイマ開始。
...
// 1359 		ret = man_timer_start_wait(TIMER_MAN_ID_APL_LTE + MAN_LTE_SEQ_LTE_POWOFF, MAN_LTE_OFF_WAIT_TIME, man_lte_req_callback);
        LDR      R2,??man_lte_main_215+0x10
        LDR      R1,??DataTable6  ;; 0xbb8
        LDR      R0,??DataTable4_3  ;; 0x4040004c
          CFI FunCall man_timer_start_wait
        BL       man_timer_start_wait
// 1360 		if (ret < 0) {
        CMP      R0,#+0
        BPL      ??man_lte_main_220
...
// 1373 		ret = man_timer_start_wait(TIMER_MAN_ID_APL_LTE + MAN_LTE_SEQ_LTE_POWOFF_WAIT, MAN_LTE_STS_OFF_WAIT_TIME, man_lte_req_callback);
        LDR      R2,??man_lte_main_215+0x10
        LDR      R1,??man_lte_main_204  ;; 0x7530
        LDR      R0,??DataTable7  ;; 0x4040004f
          CFI FunCall man_timer_start_wait
        BL       man_timer_start_wait
// 1374 		if (ret < 0) {
        CMP      R0,#+0
        BPL      ??man_lte_main_221
...
??man_lte_main_176:
        ...
        LDR      R0,[R0, #+60]
        CMP      R0,#+0
        BEQ      ??man_lte_main_224
        SUBS     R0,R0,#+1
        BEQ      ??man_lte_main_225
        SUBS     R0,R0,#+10
        BEQ      ??man_lte_main_226
        SUBS     R0,R0,#+1
        CMP      R0,#+2
        BHI      .+4
        B        ??man_lte_main_227
...
??man_lte_main_225:
        ...
        LDRB     R0,[R0, #+1]
        CMP      R0,#+5
        BEQ      ??man_lte_main_230
        CMP      R0,#+31
        BEQ      ??man_lte_main_231
        CMP      R0,#+38
        BEQ      ??man_lte_main_232
        CMP      R0,#+50
        BEQ      ??man_lte_main_233
        CMP      R0,#+54
        BEQ      ??man_lte_main_234
        CMP      R0,#+61
        BEQ      ??man_lte_main_235
        CMP      R0,#+64
        BEQ      ??man_lte_main_236
        B        ??man_lte_main_237
...
??man_lte_main_231:
        LDR      R1,??DataTable6  ;; 0xbb8
        LDR      R0,??DataTable16_1  ;; 0x4040001f
          CFI FunCall man_timer_cancel_wait
        BL       man_timer_cancel_wait
// 1420 			break;
        B        ??man_lte_main_238
...
??man_lte_main_232:
        LDR      R1,??DataTable8  ;; 0x7530
        LDR      R0,??DataTable16_2  ;; 0x40400026
          CFI FunCall man_timer_cancel_wait
        BL       man_timer_cancel_wait
// 1423 			break;
        B        ??man_lte_main_238
...
??man_lte_main_226:
        ...
        LDRB     R0,[R0, #+1]
        CMP      R0,#+5
        BEQ      ??man_lte_main_239
        CMP      R0,#+31
        BEQ      ??man_lte_main_240
        CMP      R0,#+38
        BEQ      ??man_lte_main_241
        CMP      R0,#+50
        BEQ      ??man_lte_main_242
        CMP      R0,#+54
        BEQ      ??man_lte_main_243
        CMP      R0,#+61
        BEQ      ??man_lte_main_244
        CMP      R0,#+64
        BEQ      ??man_lte_main_245
        B        ??man_lte_main_246
...
??man_lte_main_242:
        LDR      R1,??DataTable17  ;; 0x1388
        LDR      R0,??DataTable16_3  ;; 0x40400032
          CFI FunCall man_timer_cancel_wait
        BL       man_timer_cancel_wait
// 1463 			break;
        B        ??man_lte_main_247
...
??man_lte_main_243:
        LDR      R1,??DataTable17  ;; 0x1388
        LDR      R0,??DataTable17_1  ;; 0x40400036
          CFI FunCall man_timer_cancel_wait
        BL       man_timer_cancel_wait
// 1466 			break;
        B        ??man_lte_main_247
...
// 1511 						man_http_lte_get_cpsi(0, NULL);
        MOVS     R1,#+0
        MOVS     R0,#+0
          CFI FunCall man_http_lte_get_cpsi
        BL       man_http_lte_get_cpsi
// 1512 					}
// 1513 				}
// 1514 			}
...
// 1539 	man_lte_work.request.req_cmd = MAN_CMD_REQ_CMD_INIT;
        MOVS     R3,#+1
        LDR      R4,??DataTable17_3
        STR      R3,[R4, #+4]
// 1540 	man_lte_work.request.id = id;
        LDR      R3,??DataTable17_3
        STR      R2,[R3, #+8]
...
// 1557 /********************************************************************/
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function man_lte_req_ready
          CFI NoCalls
        THUMB
...
// 1581 /********************************************************************/
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function man_lte_req_start
          CFI NoCalls
        THUMB
...
// 1653 /********************************************************************/
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function man_lte_req_wakeup
          CFI NoCalls
        THUMB
...
// 1676 /********************************************************************/
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function man_lte_req_reset
          CFI NoCalls
        THUMB
...
// 1723 /********************************************************************/
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function man_lte_noti_state
          CFI NoCalls
        THUMB
...
// 1748 /********************************************************************/
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function man_lte_req_state
          CFI NoCalls
        THUMB
...
// 1781 /********************************************************************/
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function man_lte_1000ms_main
        THUMB
...
// 1799 /********************************************************************/
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function man_lte_disp_info
        THUMB
...
??DataTable17_5:
        ...
        DATA
?_0:
        DC8 "VLTE OFF\015\012"
        DC8 0

        SECTION `.rodata`:CONST:REORDER:NOROOT(2)
        DATA
?_1:
        DC8 4CH, 54H, 45H, 20H, 49H, 4EH, 46H, 4FH
        DC8 20H, 3AH, 3AH, 20H, 6FH, 74H, 61H, 5FH
        DC8 6FH, 66H, 66H, 3DH, 25H, 64H, 2CH, 20H
        DC8 73H, 74H, 73H, 3DH, 25H, 30H, 32H, 78H
        DC8 2CH, 20H, 72H, 65H, 71H, 20H, 63H, 6DH
        DC8 64H, 3DH, 25H, 64H, 2CH, 20H, 72H, 65H
        DC8 71H, 20H, 73H, 74H, 61H, 74H, 65H, 3DH
        DC8 25H, 64H, 0AH, 0
